...
- Hyper-parameter tuning to classify raisins.
- K-means to recognize handwriting digits.
- Principal component analysis
- Random forest and boosting to predict income.
- Naive Bayes Classifier to [analyze email similarity](NaiveBayesClassifier.ipynb), [classify tweets location](tweet_loc_viral.ipynb).
